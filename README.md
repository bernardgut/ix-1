...
4. Set up the environment:
   ...
   ./deps/dpdk/tools/dpdk_nic_bind.py -b igb_uio <DEVICE_BUS_ADDR>
   sudo insmod deps/dune/kern/dune.ko
   ```

where `DEVICE_BUS_ADDR` is the PCI device bus address, e.g `0000:01:00.0`.
...
**[This is currently not supported on this branch]**
